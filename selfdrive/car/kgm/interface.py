...
from selfdrive.car.kgm.tunes import LatTunes, LongTunes, set_long_tune, set_lat_tune
from selfdrive.car.kgm.values import CAR, EV_CAR, HYBRID_CAR, Buttons, CarControllerParams
...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=[], disable_radar=False):  # pylint: disable=dangerous-default-value
    ...
    ret.carName = "kgm"
    ret.safetyConfigs = [get_safety_config(car.CarParams.SafetyModel.kgm, 0)]
    ...
    # Most kgm car ports are community features for now
    ...
    # genesis
    if candidate == CAR.TORRES_EVX:
      ret.mass = 1940. + STD_CARGO_KG
      ret.wheelbase = 2.68
