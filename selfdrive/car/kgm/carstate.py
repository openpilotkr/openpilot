...
from selfdrive.car.kgm.values import DBC, STEER_THRESHOLD, FEATURES, EV_CAR, HYBRID_CAR, Buttons, CAR
...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp2, cp_cam):
    ...
    # Gear Selection via Cluster - For those kgm which are not fully discovered, we can use the Cluster Indicator for Gear Selection,
