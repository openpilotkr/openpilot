...
from selfdrive.car.kgm.values import CAR, CHECKSUM, FEATURES
from common.params import Params

kgm_checksum = crcmod.mkCrcFun(0x11D, initCrc=0xFD, rev=False, xorOut=0xdf)
